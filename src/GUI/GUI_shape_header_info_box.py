...
class GuiShapeHeaderInfoBox(tk.Frame):
    def __init__(self, parent, gui_main):
        ...
        # file header box
        self.file_header_labelframe = tk.LabelFrame(parent, text="Shape Header")
        self.file_header_labelframe.place(x=5, y=5, width=340, height=90)

        # signature label+box
        self.fh_label_sign = tk.Label(self.file_header_labelframe, text="Signaaaaaaature:", anchor="w")
        ...
        # header+TOC size label+box
        self.fh_label_header_and_toc_size = tk.Label(self.file_header_labelframe, text="H/TOC size:", anchor="w")
        self.fh_label_header_and_toc_size.place(x=160, y=35, width=90, height=20)
        self.fh_text_header_and_toc_size = tk.Text(
            self.file_header_labelframe,
            bg=self.file_header_labelframe["bg"],
            state="disabled",
        )
        self.fh_text_header_and_toc_size.place(x=250, y=35, width=80, height=20)
        self.fh_text_header_and_toc_size.bind("<Button-3>", lambda event, arg=self: RightClicker(arg, event))
