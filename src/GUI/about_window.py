...
class AboutWindow:
    def __init__(self, gui_object):
        ...
        self.about_window.wm_title("About EA Font Manager")
        ...
        self.about_title_label_tool_name_label = tk.Label(
            self.about_title_frame, text="EA Font Manager", font=("Arial", 20), anchor="center"
        )
        ...
        copyright_text: str = (
            "Copyright 2025 © Bartlomiej Duda. All Rights Reserved.\n"
            "For the latest version visit EA Font Manager Github page at\n"
        )
        ...
        github_link: str = "https://github.com/bartlomiejduda/EA-Font-Manager"
